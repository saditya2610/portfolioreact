                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Sadit Aditya</b>
                ...
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".1s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Always believe in hard-work with Allah May Great my profession</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    ...
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <p>
                          ...
                          <a
                            href="https://repository.uin-suska.ac.id/72565/"
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            UIN SUSKA RIAU ( Learning and Management
                            Science)
                          </a>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “Sadit has done a fantastic job overall.
                  ...
                  <div className="row">
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        ...
                        >
                          <img
                            src="assets/img/blog/sispol.png"
                            alt="Learn React JS"
                            className="blog-img"
                          />
                        </a>
                    ...
                    <div className="col-md-4 col-sm-6">
                      <div className="blog-main">
                        ...
                        >
                          <img
                            src="assets/img/blog/kalkulator.png"
                            alt="tokogame"
                            className="blog-img"
                          />
                        </a>
                        ...
                        <div className="blog-bottom">
                          <p>
                          Menggunakan Javascript berbasis HTML
                          </p>
                          <a
                            href="https://saditya2610.github.io/kalkulator/"
                            target="_blank"
